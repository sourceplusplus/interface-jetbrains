...
class RealOverviewPage(private val portalUuid: String) {
    ...
    init {
        ...
        eb.onopen = {
            ...
            eb.publish(RealOverviewTabOpened, json("portalUuid" to portalUuid))
            eb.send(RefreshRealOverview, json("portalUuid" to portalUuid)) //todo: opened tab should imply refresh
        }
    }
