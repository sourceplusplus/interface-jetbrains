...
object ArtifactScopeService : AbstractSourceMarkerService<IArtifactScopeService>(), IArtifactScopeService {
    ...
    override fun getCallerExpressions(element: PsiElement, includeIndirect: Boolean): List<PsiElement> {
        return getService(element.language).getCallerExpressions(element, includeIndirect)
    }
...
fun PsiElement.getCallerFunctions(): List<PsiElement> {
    return ArtifactScopeService.getService(language).getCallerFunctions(this)
}

fun PsiElement.getCallerExpressions(): List<PsiElement> {
    return ArtifactScopeService.getService(language).getCallerExpressions(this)
}
