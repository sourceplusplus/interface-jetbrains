...
import spp.jetbrains.artifact.service.getCallerExpressions
import spp.jetbrains.artifact.service.getCallerFunctions
...
fun ArtifactElement.getCallerFunctions(): List<FunctionArtifact> {
    return psiElement.getCallerFunctions().map { it.toArtifact() }.filterIsInstance<FunctionArtifact>()
}

fun ArtifactElement.getCallerExpressions(): List<ArtifactElement> {
    return psiElement.getCallerExpressions().map { it.toArtifact() }.filterIsInstance<ArtifactElement>()
}
