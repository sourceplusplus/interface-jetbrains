...
import spp.jetbrains.marker.py.detect.endpoint.FlaskEndpoint
 ...
 */
class PythonEndpointDetector(project: Project) : EndpointDetector<EndpointNameDetector>(project) {
