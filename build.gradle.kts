...
tasks {
    register("downloadSkywalking") {
        doLast {
            ...
            val f = File(projectDir, "test/e2e/apache-skywalking-apm-es7-8.2.0.tar.gz")
            if (!f.exists()) {
                java.net.URL("https://downloads.apache.org/skywalking/8.2.0/apache-skywalking-apm-es7-8.2.0.tar.gz")
