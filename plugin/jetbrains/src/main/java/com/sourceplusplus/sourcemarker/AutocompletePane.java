...
public final class AutocompletePane extends JTextPane implements FocusListener, DocumentListener, KeyListener {
    ...
    public AutocompletePane(String placeHolderText, Function<String, List<String>> lookup) {
        super();
...
//        popup.setOpacity(0.5f);
        ...
        JScrollPane scroll = new JScrollPane(list) {
            ...
            public Dimension getPreferredSize() {
                ...
                ps.width = AutocompletePane.this.getWidth();
                return ps;
            }
        };
    ...
    private void showAutocompletePopup() {
        final Point los = AutocompletePane.this.getLocationOnScreen();
    ...
    private class ListModel extends AbstractListModel {
        ...
        public void updateView() {
            super.fireContentsChanged(AutocompletePane.this, 0, getSize());
        }
    }
