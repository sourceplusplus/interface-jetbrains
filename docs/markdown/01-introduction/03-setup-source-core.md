...
```sh
cd /opt
wget https://github.com/sourceplusplus/Assistant/releases/download/v0.2.5-alpha/source-core-0.2.5.zip
unzip source-core-0.2.5.zip
rm source-core-0.2.5.zip
mv source-core-0.2.5 source-core
```
