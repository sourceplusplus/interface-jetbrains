...
```sh
cd /opt
wget https://github.com/sourceplusplus/Assistant/releases/download/v0.3.2-alpha/source-core-0.3.2.zip
unzip source-core-0.3.2.zip
rm source-core-0.3.2.zip
mv source-core-0.3.2 source-core
```
